...
declare i64 @SCM_STRING_CMP (i64, i64)
declare i64 @SCM_EQ (i64, i64)
declare i64 @SCM_EQV (i64, i64)
declare i64 @SCM_MAKE_STRING (i64, i64)
declare i64 @SCM_IS_EOF(i64)
declare i64 @SCM_EOF(i64)
declare i64 @SCM_IS_FLONUM(i64)
declare i64 @SCM_IS_BIGNUM(i64)
declare i64 @SCM_IS_RATNUM(i64)
declare i64 @SCM_NUMERATOR(i64)
declare i64 @SCM_DENOMINATOR(i64)
declare i64 @SCM_IS_COMPNUM(i64)
declare i64 @SCM_DOUBLE_AS_U64(i64)
declare i64 @SCM_ISNAN(i64)
declare i64 @SCM_ISINF(i64)
declare i64 @SCM_REAL_PART(i64)
declare i64 @SCM_IMAG_PART(i64)
declare i64 @SCM_CHAR_INTEGER(i64)
declare i64 @SCM_INTEGER_CHAR(i64)
declare i64 @SCM_CHAR_ALPHABETIC(i64)
declare i64 @SCM_CHAR_UPPERCASE(i64)
declare i64 @SCM_CHAR_LOWERCASE(i64)
declare i64 @SCM_CHAR_NUMERIC(i64)
declare i64 @SCM_CHAR_WHITESPACE(i64)
declare i64 @SCM_UPCASE(i64)
declare i64 @SCM_DOWNCASE(i64)
declare i64 @SCM_FOLDCASE(i64)
...
declare i64 @SCM_STRING_REF_FAST(i64,i64)
...
declare i64 @SCM_RECORD_SET_FAST(i64, i64, i64)
...
declare i64 @SCM_MAKE_RECTANGULAR(i64)
