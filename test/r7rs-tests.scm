...
(define (approx-equal? a b epsilon)
  ;;(display "Approx equal: ") (display a) (display " ") (display b) (newline)
  (cond
   ((and (number? a) (not (real? a)) (number? b) (not (real? b)))
    ;;(display "TRING compnum\n")
    (and (approx-equal? (real-part a) (real-part b) epsilon)
	 (approx-equal? (imag-part a) (imag-part b) epsilon)))
   ((or (not (real? a)) (not (real? b))) #f)
   ((> (abs a) (abs b))
