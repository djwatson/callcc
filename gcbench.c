...
int kStretchTreeDepth    = 20;      /* about 16Mb */
int kLongLivedTreeDepth  = 18;      /* about 4Mb */
int kArraySize  = 2097148;           /* about 4Mb */
int kMinTreeDepth = 4;
int kMaxTreeDepth = 18;
...
static Node make_Node(Node l, Node r) {
    Node result = (Node) rcimmix_alloc(sizeof(struct Node0));
    result->left = l;
    result->right = r;
    return result;
}
...
int main() {
	...
	gc_init();
        ...
        printf (" Creating a long-lived array of %d doubles\n",
                kArraySize);
        array = (double *) rcimmix_alloc(kArraySize*sizeof(double));
